                                                                      ...
                                                                      child: Stack(
                                                                          children: [
                                                                            Padding(
                                                                                ...
                                                                                child: Switch(value: true, inactiveTrackColor: ColorConstant.gray_200, activeTrackColor: ColorConstant.deep_orange_700, inactiveThumbColor: ColorConstant.white_A700, activeColor: ColorConstant.white_A700, onChanged: (rating) {})),
                                                                            Padding(
                                                                                ...
                                                                                child: Switch(value: false, inactiveTrackColor: ColorConstant.deep_orange_700, activeTrackColor: ColorConstant.gray_200, inactiveThumbColor: ColorConstant.white_A700, activeColor: ColorConstant.white_A700, onChanged: (rating) {})),
                                                                            Padding(
                                                                                ...
                                                                                child: SvgPicture.asset(ImageConstant.img_group47_1, height: getVerticalSize(111.51), width: getHorizontalSize(7.41), fit: BoxFit.cover)),
                                                                            Padding(
                                                                                ...
                                                                                child: Column(crossAxisAlignment: CrossAxisAlignment.center, mainAxisAlignment: MainAxisAlignment.start, children: [
                                                                                  ...
                                                                                  Padding(padding: EdgeInsets.only(top: getVerticalSize(29), right: getHorizontalSize(241)), child: Text("lbl_about_us".tr, textAlign: TextAlign.left, style: AppStyle.textStylePoppinsregular18_2.copyWith(fontSize: getFontSize(18)))),
                                                                                  Padding(padding: EdgeInsets.only(top: getVerticalSize(22), right: getHorizontalSize(197)), child: Text("lbl_privacy_policy".tr, textAlign: TextAlign.left, style: AppStyle.textStylePoppinsregular18_2.copyWith(fontSize: getFontSize(18)))),
                                                                                  Padding(padding: EdgeInsets.only(top: getVerticalSize(23), right: getHorizontalSize(126), bottom: getVerticalSize(0)), child: Text("msg_terms_and_condi".tr, textAlign: TextAlign.left, style: AppStyle.textStylePoppinsregular18_2.copyWith(fontSize: getFontSize(18))))
                                                                                ])),
                                                                            Padding(
                                                                                padding: EdgeInsets.only(left: getHorizontalSize(8), right: getHorizontalSize(244), bottom: getVerticalSize(364)),
                                                                                child: Text("lbl_edit_profile".tr, textAlign: TextAlign.left, style: AppStyle.textStylePoppinsregular18_2.copyWith(fontSize: getFontSize(18)))),
                                                                            Padding(
                                                                                ...
                                                                                child: Text("msg_push_notificati".tr, textAlign: TextAlign.left, style: AppStyle.textStylePoppinsregular18_2.copyWith(fontSize: getFontSize(18)))),
                                                                            Padding(
                                                                                ...
                                                                                child: Text("lbl_dark_mode".tr, textAlign: TextAlign.left, style: AppStyle.textStylePoppinsregular18_2.copyWith(fontSize: getFontSize(18)))),
                                                                            Container(
