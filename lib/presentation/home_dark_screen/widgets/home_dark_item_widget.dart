...
class HomeDarkItemWidget extends StatelessWidget {
  HomeDarkItemWidget(this.homeDarkItemModelObj);

  HomeDarkItemModel homeDarkItemModelObj;

  var controller = Get.find<HomeDarkController>();
