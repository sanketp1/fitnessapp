import '../leaderboard_dark_screen/widgets/leaders_item_widget.dart';
...
class LeaderboardDarkScreen extends GetWidget<LeaderboardDarkController> {
  @override
                                  ...
                                  children: [
                                    ...
                                    Container(
                                        ...
                                        decoration: BoxDecoration(
                                            color: ColorConstant.white_A700_42,
                                            borderRadius: BorderRadius.circular(
                                        ...
                                        child: Padding(
                                            ...
                                            child: Obx(() => ListView.builder(
                                                ...
                                                itemCount: controller
                                                    .leaderboardDarkModelObj
                                                    .value
                                                    .leadersItemList
                                                    .length,
                                                itemBuilder: (context, index) {
                                                  LeadersItemModel model =
                                                      controller
                                                          .leaderboardDarkModelObj
                                                          .value
                                                          .leadersItemList[index];
                                                  return LeadersItemWidget(
                                                      model);
                                                })))),
                                    Container(
                                        width: getHorizontalSize(380),
