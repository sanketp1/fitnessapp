...
class LeaderboardDarkScreenItemWidget extends StatelessWidget {
  LeaderboardDarkScreenItemWidget(this.leaderboardDarkScreenItemModelObj);

  LeaderboardDarkScreenItemModel leaderboardDarkScreenItemModelObj;
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: ColorConstant.white_A700_1a,
